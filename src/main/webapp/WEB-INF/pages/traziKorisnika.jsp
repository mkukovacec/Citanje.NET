		...
		<div id="wrapper-container">
			<div class="container object" id="container-object">
				<div id="main-container-image">
					<section class="work">
						<form action="/Citanje.NET/pretragaKorisnika" method="post">
							<div class="polja">
					    	Unesite dio ili cijelo korisničko ime korisnika kojeg tražite:
					    	<input class="form-control prijava-polje" type="text" name="unos" value="">
					    </div>
							<input class="btn btn-primary polja" type="submit" value="Traži">
						</form>

						<%!List<Korisnik> rezPretrage;%>
						<%
							rezPretrage = (List<Korisnik>) request.getAttribute("rezPretrage");
						%>
						<%
						...
						<div class="polja">
							...
							<ul>
								<c:forEach var="k" items="${rezPretrage}">
									<li><a href="/Citanje.NET/korisnik/${k.korisnickoIme}">${k.korisnickoIme }</a></li>
								</c:forEach>
							</ul>
							<%
								}
