	  ...
	  <div id="wrapper-container">
	    <div class="container object" id="container-object">
	      <div id="main-container-image">
	        <section class="work">
						<form action="/Citanje.NET/report" method="POST">
							<fieldset>
								<h3 class="polja">Prijava korisnika</h3>

									<div class="polja">
										Korisnik
										<input class="form-control prijava-polje" type="text" name="optuzeni"  value="${optuzeni}" readonly><br>
									</div>
									<div class="polja">
										Razlog
										<input class="form-control prijava-polje" type="text" name="razlog" value=""><br>
									</div>
									<input class="btn btn-primary polja" type="submit" value="Prijavi Korisnika">
							</fieldset>
						</form>
	        </section>
	      </div>
