	  ...
	  <div id="wrapper-container">
	    <div class="container object" id="container-object">
	      <div id="main-container-image">
	        <section class="work">
						<form action="/Citanje.NET/opomena" method="POST">
							<fieldset>
								<h3 class="polja">Nova opomena</h3>
								<div class="polja">
									Korisnik
									<input class="form-control prijava-polje" type="text" name="korisnik"  value="${zapis.korisnik}" ><br>
									<c:if test="${zapis.imaPogresku('korisnik')}">
										<p class="pogreska"><c:out value="${zapis.dohvatiPogresku('korisnik')}"/></p>
									</c:if>
								</div>
								<div class="polja">
									Razlog
									<input class="form-control prijava-polje" type="text" name="poruka"  value="${zapis.poruka}" ><br>
									<c:if test="${zapis.imaPogresku('poruka')}">
										<p class="pogreska"><c:out value="${zapis.dohvatiPogresku('poruka')}"/></p>
									</c:if>
								</div>
								<div class="polja">
									Stupanj
									<input class="form-control prijava-polje" type="text" name="stupanj" value="${zapis.stupanj}" ><br>
									<c:if test="${zapis.imaPogresku('stupanj')}">
										<p class="pogreska"><c:out value="${zapis.dohvatiPogresku('stupanj')}"/></p>
									</c:if>
								</div>

								<input class="btn btn-primary polja" type="submit" value="Opomeni">
							</fieldset>
						</form>
	        </section>
	      </div>
