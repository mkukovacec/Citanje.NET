		...
		<div id="wrapper-container">
			<div class="container object" id="container-object">
				<div id="main-container-image">
					<section class="work">
						<form action="/Citanje.NET/djelo/${djelo.id}/dodajKomentar"
							method="post">
							<fieldset>
								<h3 class="polja">Novi komentar</h3>
								<div class="polja">
									Komentar:
									<textarea class="form-control biografija" rows="10" cols="30"
										name="komentar">${noviKomentar.komentar}</textarea>
									<c:if test="${noviKomentar.imaPogresku('komentar')}">
										<p class="pogreska">
											<c:out value="${noviKomentar.dohvatiPogresku('komentar')}" />
										</p>
									</c:if>
								</div>
								<div class="polja">
									<input class="form-control prijava-polje" type="hidden"
										name="ocjena" value="5"><br>
									<c:if test="${noviKomentar.imaPogresku('ocjena')}">
										<p class="pogreska">
											<c:out value="${noviKomentar.dohvatiPogresku('ocjena')}" />
										</p>
									</c:if>
								</div>
								<input class="btn btn-success polja" type="submit" name="metoda1"
									value="Dodaj">
							</fieldset>
						</form>
					</section>
