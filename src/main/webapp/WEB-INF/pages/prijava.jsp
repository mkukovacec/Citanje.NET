		...
		<div id="wrapper-container">
			<div class="container object" id="container-object">
				<div id="main-container-image">
					<section class="work">
						<form action="/Citanje.NET/prijava" method="post">
							<fieldset>
								<div class="polja">Korisničko ime:
									<input class="form-control prijava-polje" type="text" name="nick" value="">
								</div>
								<div class="polja">Šifra:
									<input class="form-control prijava-polje" type="password" name="passwd" value="">
								</div>
								<p class="pogreska polja">${errorMessage}</p>
								<input class="btn btn-primary polja" type="submit" value="Prijava">
							</fieldset>
						</form>
					</section>
				</div>
