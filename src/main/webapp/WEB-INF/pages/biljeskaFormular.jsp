		...
		<div id="wrapper-container">
			<div class="container object" id="container-object">
				<div id="main-container-image">
					<section class="work">
						<form action="/Citanje.NET/djelo/${djelo.id}/dodajBiljesku"
							method="post">
							<fieldset>
								<h3 class="polja">Nova bilješka</h3>
								<div class="polja">
									Bilješka:
									<textarea class="form-control biografija" rows="10" cols="30"
										name="tekst">${novaBiljeska.tekst}</textarea>
									<c:if test="${novaBiljeska.imaPogresku('tekst')}">
										<p class="pogreska">
											<c:out value="${novaBiljeska.dohvatiPogresku('tekst')}" />
										</p>
									</c:if>
								</div>
