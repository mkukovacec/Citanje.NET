...
<html>
	<head>
		...
		<title>Upravljanje prijavama</title>
		...
		<div id="wrapper-container">
			<div class="container object" id="container-object">
				<div id="main-container-image">
					<section class="work">
						<h2 class="polja">Prijave</h2>
						<legend class="legend"></legend>
						<ul>
							<c:forEach var="report" items="${reports}">
								<li class="polja"><p>
										Prijavljeni korisnik: <a
											href="/Citanje.NET/korisnik/${report.prijavljeniKorisnik.korisnickoIme}">${report.prijavljeniKorisnik.ime}
											${report.prijavljeniKorisnik.prezime}</a>
									</p>
									<p>
										Prijavljen od korisnika: <a
											href="/Citanje.NET/korisnik/${report.tuzitelj.korisnickoIme}">${report.tuzitelj.ime}
											${report.tuzitelj.prezime }</a>
									</p>
									<p>
										Razlog prijave: ${report.razlog}
									<p>
										<c:choose>
											<c:when test="${report.prijavljeniKorisnik.isBanned}">
												<a class="btn btn-primary"
													href="/Citanje.NET/kontrolpanel/reporti/ban/${report.prijavljeniKorisnik.id}">Omogući
													pristup</a>
											</c:when>
											<c:otherwise>
												<a class="btn btn-primary"
													href="/Citanje.NET/kontrolpanel/reporti/ban/${report.prijavljeniKorisnik.id}">Zabrani
													pristup</a>
											</c:otherwise>
										</c:choose>
										<a class="btn btn-primary" href="/Citanje.NET/opomena/${report.prijavljeniKorisnik.id}">
											Opomeni korisnika
										</a>
										<a class="btn btn-primary" href="/Citanje.NET/kontrolpanel/reporti/brisanje/${report.id}">
											Obriši report
										</a>
									</p></li>
								<legend class="legend"></legend>
