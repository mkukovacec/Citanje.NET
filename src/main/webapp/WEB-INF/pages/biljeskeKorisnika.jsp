		...
		<div id="wrapper-container">
			<div class="container object" id="container-object">
				<div id="main-container-image">
					<section class="work">
					  <a class="btn btn-warning polja" href="/Citanje.NET/korisnik/${korisnik.korisnickoIme}">
					  	Povratak
						</a>
						<legend class="legend"></legend>
						<ul>
							<c:forEach var="biljeska" items="${korisnik.biljeske}">
								<li class="polja"><a
									href="/Citanje.NET/djelo/${biljeska.djelo.id}">
										${biljeska.djelo.naslov } </a> <c:choose>
										<c:when test="${biljeska.tekst == zaUredivanje.tekst }">
											<form
												action="/Citanje.NET/korisnik/${korisnik.korisnickoIme}/biljeske/${biljeska.id}/uredi"
												method="post">
											...
											<c:if test="${trenutni!=null }">
												<c:if
													...
													<a class="btn btn-danger"
														href="/Citanje.NET/korisnik/${korisnik.korisnickoIme}/biljeske/${biljeska.id}/brisi">Briši</a>
													<a class="btn btn-primary"
														href="/Citanje.NET/korisnik/${korisnik.korisnickoIme}/biljeske/${biljeska.id}/uredi">Uredi</a>
												</c:if>
											</c:if>
										</c:otherwise>
									</c:choose></li>
